...
public class ExtendedItems {
    ...
    public static final ItemEntry<Item> WRENCH_COG_AUGMENT = REGISTRATE.item("wrench_cog_augment", Item::new)
    ...
    public static void addToCreative(BuildCreativeModeTabContentsEvent event) {
        if(event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
            ...
            event.insertAfter(WRENCH_COG_AUGMENT.asStack(), WRENCH_AXIS_AUGMENT.asStack(), CreativeModeTab.TabVisibility.PARENT_AND_SEARCH_TABS);
        }
    }
