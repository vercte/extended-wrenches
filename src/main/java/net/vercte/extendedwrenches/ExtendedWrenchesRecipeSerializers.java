...
public class ExtendedWrenchesRecipeSerializers {
    ...
    public static final Supplier<RecipeSerializer<WrenchDyeRecipe>> WRENCH_DYE = RECIPE_SERIALIZERS.register("wrench_dye", () -> new SimpleCraftingRecipeSerializer<>(WrenchDyeRecipe::new));
